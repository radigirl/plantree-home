export const en = {
  ...
  groceryLists: {
    ...
    archivePantryMessageMany: 'This list still has {{count}} items that can be moved to Pantry.',
    movedOneToPantry: '1 item moved to Pantry',
    movedManyToPantry: '{{count}} items moved to Pantry',
    movedOneCompleted: '1 item moved to Pantry and list completed',
    movedManyCompleted: '{{count}} items{{alwaysPresent}} moved to Pantry and list completed',
    movedOneArchived: '1 item{{alwaysPresent}} moved to Pantry and list archived',
    movedManyArchived: '{{count}} items{{alwaysPresent}} moved to Pantry and list archived',
    covers: 'Covers:',
    more: 'more',
    copy: 'copy',
    movedToPantryResult: '{{count}} items{{alwaysPresent}} moved to Pantry',
    alwaysPresentSkippedResult: ' (+{{count}} always present)',
    movingToPantry: 'Moving to pantry...',
  },
  groceryListDetails: {
    backToLists: 'Lists',
    complete: 'Complete',
