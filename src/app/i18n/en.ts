export const en = {
  ...
  groceryLists: {
    ...
    movedManyCompleted: '{{count}} items moved to Pantry and list completed',
    movedOneArchived: '1 item moved to Pantry and list archived',
    movedManyArchived: '{{count}} items moved to Pantry and list archived',
    covers: 'Covers:',
    more: 'more',
    copy: 'copy',
  },
