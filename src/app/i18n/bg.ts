export const bg = {
  ...
  generateSheet: {
    ...
    noAvailableMealsToGenerate: 'Няма ястия, от които да се създаде списък.',
    ...
    noIngredientsForList: 'Добави съставки към рецептите, за да генерираш списък.',
    noIngredients: 'Няма съставки',
  },
  dayDetails: {
  ...
  groceryLists: {
    ...
    movedManyCompleted: '{{count}} продукта{{alwaysPresent}} са преместени в „Продукти“ и списъкът е завършен',
    movedOneArchived: '1 продукт{{alwaysPresent}} е преместен в „Продукти“ и списъкът е архивиран',
    movedManyArchived: '{{count}} продукта{{alwaysPresent}} са преместени в „Продукти“ и списъкът е архивиран',
    covers: 'Включва:',
    more: 'още',
    copy: 'копие',
    movedToPantryResult: '{{count}} продукта{{alwaysPresent}} са преместени в „Продукти“',
    alwaysPresentSkippedResult: ' (+{{count}} винаги налични)',
    movingToPantry: 'Преместване в „Продукти“...',
  },
  groceryListDetails: {
    backToLists: 'Списъци',
    complete: 'Завърши',
